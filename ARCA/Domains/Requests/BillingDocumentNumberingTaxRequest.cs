// <copyright file="BillingDocumentNumberingTaxRequest.cs" company="PlaceholderCompany">
// Copyright (c) PlaceholderCompany. All rights reserved.
// </copyright>

namespace ElRoso.ARCA.Domains.Requests;

public class BillingDocumentNumberingTaxRequest
{
    private double baseAmount;
    private double amount;

    public string PercentageTax { get; set; } = string.Empty;
